...
__C.AZURE = edict()
__C.AZURE.ACCOUNT_NAME = os.environ['STORAGE_ACCOUNT_NAME']
__C.AZURE.ACCOUNT_KEY = os.environ['STORAGE_ACCOUNT_KEY']
__C.AZURE.PRETRAINED_MODELS = "pretrainedmodels"
__C.AZURE.DATA="data"
#
# CNTK parameters
#
